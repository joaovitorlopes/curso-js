...
var GenerateCPF = /*#__PURE__*/function () {
  ...
  _createClass(GenerateCPF, [{
    ...
    value: function generateNewCPF() {
      ...
      var digit1 = _validateCPF__WEBPACK_IMPORTED_MODULE_0__["default"].generateDigits(cpfWithoutDigit);
      var digit2 = _validateCPF__WEBPACK_IMPORTED_MODULE_0__["default"].generateDigits(cpfWithoutDigit + digit1);
...
var ValidateCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidateCPF, [{
    key: "hasSequence",
    value: function hasSequence() {
      return this.clearCPF.charAt(0).repeat(this.clearCPF.length) === this.clearCPF;
    }
  }, {
    key: "generateNewCPF",
    value: function generateNewCPF() {
      var cpfNoDigits = this.clearCPF.slice(0, -2);
      var digit1 = ValidateCPF.generateDigits(cpfNoDigits);
      var digit2 = ValidateCPF.generateDigits(cpfNoDigits + digit1);
    ...
    key: "generateDigits",
    value: function generateDigits(cpfNoDigits) {
      var total = 0;
      var reverso = cpfNoDigits.length + 1;
